...
(local VOLUME_UP "sh -c 'pactl set-sink-mute @DEFAULT_SINK@ false ; pactl set-sink-volume $(pactl get-default-sink) +5%'")
(local VOLUME_DOWN "sh -c 'pactl set-sink-mute @DEFAULT_SINK@ false ; pactl set-sink-volume $(pactl get-default-sink) -5%'")
(local VOLUME_TOGGLE "sh -c 'pactl set-sink-mute @DEFAULT_SINK@ toggle'")
(local MIC_TOGGLE "sh -c 'pactl set-source-mute @DEFAULT_SOURCE@ toggle'")
